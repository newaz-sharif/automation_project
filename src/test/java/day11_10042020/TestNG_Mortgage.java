...
public class TestNG_Mortgage {
    ...
    public void setDriver() throws IOException, BiffException {
        ...
        readableFile = Workbook.getWorkbook(new File("src/main/resources/mortgage.xls"));
        ...
        writableFile = Workbook.createWorkbook(new File("src/main/resources/mortgage_results.xls"),readableFile);
