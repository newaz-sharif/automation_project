...
public class mlcalc_with_for_loop {
    public static void main(String[] args) throws InterruptedException {
        ...
        //set the values for the Payment array list
        ArrayList<String>dPaymentList = new ArrayList<>();
        dPaymentList.add("30");
        dPaymentList.add("50");

        //call for the for loop to iterate through the array list
        for (int i = 0; i < pPriceList.size(); i++){
            ...
            try {
                ...
                System.out.println("Unble to capture the monthly payment " + err);
